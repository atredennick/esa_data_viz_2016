...
{\centering \includegraphics[width=.75\linewidth]{figure/gapminder} 
...
{\centering \includegraphics[width=.75\linewidth]{figure/gapminder3} 
...
\hlstd{conts} \hlkwb{<-} \hlkwd{unique}\hlstd{(gapminder[,}\hlstr{"continent"}\hlstd{])}
\hlstd{cols} \hlkwb{<-} \hlstd{scales::}\hlkwd{hue_pal}\hlstd{()(}\hlkwd{length}\hlstd{(conts))}
\hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{))}
\hlstd{counter}\hlkwb{<-}\hlnum{1}
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlstd{conts)\{}
  \hlkwd{plot}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"gdpPercap"}\hlstd{],}
       \hlstd{gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"lifeExp"}\hlstd{],} \hlkwc{col}\hlstd{=cols[counter],}
       \hlkwc{xlab}\hlstd{=}\hlstr{"Per Capita GDP"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Life Expectancy (yrs)"}\hlstd{,}
       \hlkwc{main}\hlstd{=i,} \hlkwc{las}\hlstd{=}\hlnum{1}\hlstd{,} \hlkwc{log}\hlstd{=}\hlstr{"x"}\hlstd{)}
  \hlstd{fit} \hlkwb{<-} \hlkwd{lm}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"lifeExp"}\hlstd{]}\hlopt{~}
              \hlkwd{log}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"gdpPercap"}\hlstd{]))}
  \hlstd{pred} \hlkwb{<-} \hlkwd{predict}\hlstd{(fit,} \hlkwc{interval} \hlstd{=} \hlstr{"confidence"}\hlstd{)}
  \hlkwd{lines}\hlstd{(}\hlkwd{sort}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"gdpPercap"}\hlstd{]),}
        \hlkwd{sort}\hlstd{(pred[,}\hlnum{1}\hlstd{]))}
  \hlkwd{lines}\hlstd{(}\hlkwd{sort}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"gdpPercap"}\hlstd{]),}
        \hlkwd{sort}\hlstd{(pred[,}\hlnum{2}\hlstd{]),} \hlkwc{lty}\hlstd{=}\hlnum{2}\hlstd{)}
  \hlkwd{lines}\hlstd{(}\hlkwd{sort}\hlstd{(gapminder[}\hlkwd{which}\hlstd{(gapminder}\hlopt{$}\hlstd{continent}\hlopt{==}\hlstd{i),}\hlstr{"gdpPercap"}\hlstd{]),}
        \hlkwd{sort}\hlstd{(pred[,}\hlnum{3}\hlstd{]),} \hlkwc{lty}\hlstd{=}\hlnum{2}\hlstd{)}
