...
\begin{frame}[fragile]
\frametitle{1 minute}
<<gapminder, tidy=FALSE, echo=FALSE, fig.width=6, fig.height=5, out.width='.75\\linewidth', fig.align='center'>>=
library(ggplot2)
library(gapminder)
...
<<gapminder3, tidy=FALSE, echo=FALSE, fig.width=6, fig.height=5, out.width='.75\\linewidth', fig.align='center'>>=
library(scales)
